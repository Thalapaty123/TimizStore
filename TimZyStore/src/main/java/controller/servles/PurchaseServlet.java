	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String username = (String) request.getSession().getAttribute("username");
		 if (username != null) {
	        	...
	        	System.out.print("purchase result is : " + result);
	        	if (result == 1) {
	                request.setAttribute("successMessage", "Product Purchased successfully");
	            } 
	            else {
	                request.setAttribute("errorMessage", "Failed to purchase product");
	            }
